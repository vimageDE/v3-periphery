...
import { IUniswapV3Factory, IWETH9, MockFeeContract, MockTimeSwapRouter } from '../../typechain'
...
export const v3RouterFixture: Fixture<{
  ...
  const fee = (await (await ethers.getContractFactory('MockFeeContract')).deploy(
  ...
  return { factory, weth9, router, fee }
}
